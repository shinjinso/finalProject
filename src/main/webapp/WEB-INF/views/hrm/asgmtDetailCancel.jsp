...
<%--     <div style="width: 30%; display: inline-block; margin-top: 10px; "  class="alert alert-danger" role="alert">발령 사유<br>${asgmtDetailList[0].asgmtRsn }</div> --%>
			    ...
			    <tbody>
						...
						<c:choose>
			                <c:when test="${asgvo2.empVO.ptnCode !=null}">
				                ...
				                <td  style="border-right: 1px #ddd solid;">${asgvo2.empVO.grdCode }</td>
			              	 </c:when>
			                 ...
			                 <c:when test="${asgvo2.empVO.ptnCode ==null}">
				                ...
				                <td  style="border-right: 1px #ddd solid;">${asgvo2.VO.grdCode }</td>
			                 </c:when>
			                 </c:choose>
