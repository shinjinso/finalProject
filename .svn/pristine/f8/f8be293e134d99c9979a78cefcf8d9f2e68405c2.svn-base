...
<script>
	function fAutoFill1() {
		$("#authrtNm").val("인사담당자");
		$("#authrtExpln").val("인사업무를 담당하는 담당자");
		$("#menu11").prop('checked', true);
		$("#menu12").prop('checked', false);
		...
		$("#menu41").prop('checked', false);
		$("#menu51").prop('checked', false);
		$("#menu61").prop('checked', false);
	...
	function fAutoFill2() {
		$("#authrtNm").val("근무담당자");
		$("#authrtExpln").val("근무업무를 담당하는 담당자");
		$("#menu11").prop('checked', true);
		$("#menu12").prop('checked', false);
		$("#menu13").prop('checked', false);
		$("#menu21").prop('checked', false);
		$("#menu22").prop('checked', false);
		$("#menu23").prop('checked', true);
		$("#menu31").prop('checked', false);
		$("#menu32").prop('checked', false);
		$("#menu33").prop('checked', false);
		$("#menu41").prop('checked', true);
		$("#menu51").prop('checked', true);
		$("#menu61").prop('checked', false);
		$("#menu71").prop('checked', false);
		$("#menu72").prop('checked', false);
		$("#menu73").prop('checked', false);
		$("#menu74").prop('checked', false);
		$("#menu75").prop('checked', false);
	}
	
	function fAutoFill3() {
		$("#authrtNm").val("급여담당자");
		$("#authrtExpln").val("급여업무를 담당하는 담당자");
		$("#menu11").prop('checked', true);
		$("#menu12").prop('checked', false);
		$("#menu13").prop('checked', false);
		$("#menu21").prop('checked', false);
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<sec:csrfInput />
					...
					<br><br><br>
					<div class="modal-footer">
						<button type="button" class="cancelBtn" onclick="fAutoFill1()">인사</button>
						<button type="button" class="cancelBtn" onclick="fAutoFill2()">근무</button>
						<button type="button" class="cancelBtn" onclick="fAutoFill3()">급여</button>
