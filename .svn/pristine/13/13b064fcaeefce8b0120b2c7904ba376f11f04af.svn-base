...
<%--     <div style="width: 30%; display: inline-block; margin-top: 10px;" class="alert alert-warning" role="alert">발령 사유<br>${asgmtDetailList[0].asgmtRsn }</div> --%>
<%--     <div style="width: 30%; display: inline-block; margin-top: 10px; " class="alert alert-dark" role="alert">발령 메모<br>${asgmtDetailList[0].asgmtMm }</div> --%>
 ...
 <div class="card shadow">
			    ...
			    <tbody>
			            ...
			            <tr style="height: 50px;" class="original">
			                ...
			                <td>
			                    <div class="avatar avatar-md">
			                        <img src="${asgvo2.empImg }" onerror="this.src='/resources/images/insight-basic50x50.png'" alt="..." class="avatar-img rounded-circle" >
			                    </div>
			                </td>
			                <td>
						...
						<c:choose>
			                <c:when test="${asgvo2.empVO.ptnCode !=null}">
			                 ...
			                 <c:when test="${asgvo2.empVO.ptnCode ==null}">
				                <td >${asgvo2.VO.acenter }</td>
				                <td  >${asgvo2.VO.bcenter }</td>
				                <td >${asgvo2.VO.ccenter }</td>
				                <c:choose>
				                <c:when test="${asgvo2.VO.jcode !=null}">
				                <td >${asgvo2.VO.jcode },${asgvo2.VO.dtcode }</td>
				                </c:when>
				                <c:when test="${asgvo2.VO.jcode ==null}">
				                <td ></td>
				                </c:when>
				                </c:choose>
				                <td >${asgvo2.VO.ptnCode }</td>
				                <td >${asgvo2.VO.grdCode }</td>
			                 </c:when>
			                 </c:choose>
		                    ...
		                    <td colspan="3"  style="border-right: 1px #ddd solid;"></td>
		                    <td colspan="6"  style="border-right: 1px #ddd solid;">발령 사유 : <strong>${asgvo2.asgmtRsn}</strong></td>
		                    <td colspan="6" >발령 메모 : ${asgvo2.asgmtMm}</td>
		   				 </tr>
			                </c:forEach>
			    </tbody>
            </table>
    ...
    <c:choose>
	    <c:when test="${asgmtDetailList[0].asgmtCcst == 'C0101'}"> 
			 <button style="float: right; margin: 15px;" type="button" onclick="sUpdate()" class="mainBtn"><span class="fe fe-check fe-16 mr-2"></span>승인</button> 
	   		 <button style="float: right; margin: 15px;" type="button" data-toggle="modal" data-target="#defaultModal" class="backBtn"><span class="fe fe-x fe-16 mr-2"></span>반려</button>						        
		</c:when>
	</c:choose>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="defaultModalLabel">발령반려</h5>
                            ...
                            <div class="modal-footer">
                              <button class="backBtn" onclick="fcancel()"><span class="fe fe-x fe-16 mr-2"></span>반려</button>
                            </div>
                             <sec:csrfInput/>
                          </div>
                        </div>
