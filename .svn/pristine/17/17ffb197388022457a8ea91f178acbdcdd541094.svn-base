	...
	<div class="card shadow mb-4">
		<div class="card-body">
			...
			<div class="input-container justify-content-center">
		    	...
		    	<input type="text" class="form-control icon1" id="pdNm" name="pdNm" placeholder="ex) 사내동호회비" required /><br/>
		    </div>
		    <div class="input-container justify-content-center">
		    	<div class="garo">공제 금액</div>
		        <input type="number" class="form-control icon2" id="pdAmt" name="pdAmt" pattern="[0-9]*" placeholder="ex) 10,000 (해당시 숫자만 입력)" /><br/> <!-- 숫자만 입력할 수 있도록 고정! 정규식?? -->
		    </div>
		    <div class="input-container justify-content-center">
		    	<div class="garo">설명 *</div>
		        <input type="text" class="form-control icon3" id="pdEpn" name="pdEpn" placeholder="ex) 사내 동호회비 공제"  required /><br/>
		    </div>
