					    ...
					    <div class="">
					        ...
					        <div class="" style="position: relative; display: flex; align-items: stretch; width: 100%;">
						        <div class="form-group mb-3" style="margin-right: 20px;"> <!-- Add margin-right here -->
						            ...
						            <input type="text" id="name" class="form-control" name="empNm" value="백병철" placeholder="이름" required onblur="CheckNM()">
						        </div>
						        
						        <div class="form-group mb-3" style="margin-right: 20px;"> <!-- Add margin-right here -->
						            <label for="simpleinput">사번</label>
						            <input type="text" id="emp-num" class="form-control" name="empNo" value="20230911" placeholder="사번입력 ex)202309061" onblur="validateEmpNo()" required>
						        </div>
					        </div>
					        ...
					        <div class="" style="position: relative; display: flex; align-items: stretch; width: 100%;">
						        ...
						        <div class="form-group mb-3" style="margin-right: 20px;"> <!-- Add margin-right here -->
								   ...
								   <input type="tel" class="form-control" id="phone" name="cpNo" placeholder="휴대폰 번호를 입력하세요" value="01000000000" onblur="validatePhoneNumber()">
					    ...
					    <div class="" style="position: relative; display: flex; flex-wrap: wrap; align-items: stretch; width: 100%;">
					        ...
					        <div class="" style="position: relative; display: flex; align-items: stretch; width: 100%;">
								...
								<div class="form-group mb-3" style="margin-right: 20px;">
								    ...
								    <br>
								    <input type="button" value="주민등록번호 검사" onclick="CheckSSN()">
								</div>
						  	</div>
					        <div class="form-group mb-3" style="margin-right: 20px;">
