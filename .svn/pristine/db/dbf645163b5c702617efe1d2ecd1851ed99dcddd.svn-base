...
<!-- 		<nav aria-label="Table Paging" class="mb-0 text-muted">
	...
	function fill(){
		...
		$("#selectAcenter1").val("2").trigger('change');
		$("#selectAcenter2").val("3").trigger('change');
	...
	function fill2(){
		...
		$("#selectBcenter1").val("21").trigger('change');
		$("#selectBcenter2").val("31").trigger('change');
		fill3();
	}
	
	function fill3(){
		$("#selectCcenter0").val("111").trigger('change');
		$("#selectCcenter1").val("211").trigger('change');
		$("#selectCcenter2").val("312").trigger('change');
